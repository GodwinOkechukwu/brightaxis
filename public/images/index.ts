...
import homeImage1 from "./keybg.webp";
import homeImage2 from "./secure-payment-icon.png";
import homeImage3 from "./return-icon.png";
import homeImage4 from "./support-icon.png";
import homeImage5 from "./delivery-icon.png";
