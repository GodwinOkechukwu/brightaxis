...
export const SITE_NAME = "BrightAxis Limited";
export const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL ||
  "http://brightaxis-limited.com/"; // Update with actual URL
export const TWITTER_HANDLE = "support@brightaxis.com";
...
export const SEODATA: Record<string, SEOConfig> = {
  default: {
    ...
    description:
      "BrightAxis Limited Ltd provides cutting-edge software development, AI integration, and digital transformation strategies to scale modern enterprises.",
    keywords: [
      "BrightAxis Digital",
  ...
  home: {
    ...
    description:
      "Innovate and grow with BrightAxis. We build high-performance digital products, from mobile apps to enterprise AI systems, tailored to your business needs.",
    keywords: [
  ...
  login: {
    ...
    description:
      "Access your BrightAxis client dashboard to track project progress, manage subscriptions, and collaborate with your dev team.",
    keywords: [
      "Client login",
      "Project tracking portal",
      "BrightAxis dashboard access",
    ],
  },
  register: {
    title: `Partner with Us | Join ${SITE_NAME}`,
    description:
      "Create an account to start your project journey with BrightAxis Limited and access premium tech resources.",
    keywords: [
      "Get started with BrightAxis",
      "Project onboarding",
      "Digital partnership",
    ],
  },
