            ...
            <div id="termsOfUse" className="text-gray-600 space-y-6">
              <div>
                ...
                <p className="mt-3 leading-[1.8] text-xs md:text-sm xl:text-base">
                  By accessing the clearpath-summit Innovations platform and initiating
              ...
              <ul className="list-none space-y-5 text-xs md:text-sm xl:text-base">
                <li>
                  ...
                  clearpath-summit Innovations operates on a two-phase payment model.{" "}
                ...
                <li>
                  ...
                  7-14 days; Sea: 45-60 days) are estimates. clearpath-summit Digital
                ...
                <li>
                  ...
                  market volatility. clearpath-summit Innovations reserves the right to
                ...
                <li>
                  ...
                  list. clearpath-summit Innovations reserves the right to cancel
              ...
              <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 mt-6">
                <p className="leading-[1.6] text-xs md:text-sm italic">
                  ...
                  clearpath-summit Innovations acts as a procurement and logistics
          ...
          {activeTab === "privacyPolicy" && (
            <div id="privacyPolicy" className="text-slate-600 space-y-8">
              ...
              <div>
                ...
                <p className="mt-3 leading-[1.8] text-xs md:text-sm xl:text-base">
                  clearpath-summit Innovations collects personal information to provide
                ...
                <ul className="mt-4 space-y-3 text-xs md:text-sm xl:text-base list-none pl-0">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      ...
                      protect the clearpath-summit Innovations ecosystem.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1.5 size-1.5 rounded-full bg-primary-100 shrink-0" />
              ...
              <div className="bg-slate-900 text-white p-8 rounded-[2.5rem] shadow-xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="mt-4 leading-[1.8] text-xs md:text-sm xl:text-base opacity-80">
                    clearpath-summit Innovations employs bank-grade AES-256 encryption
              ...
              <div>
                ...
                <p className="mt-2 leading-[1.8] text-xs md:text-sm xl:text-base">
                  ...
                  <a
                    href="mailto:support@clearpath-summit.com"
                    className="text-primary-100 font-bold ml-1 hover:underline"
                  >
                    privacy@clearpath-summit.com
                  </a>
                  .
                </p>
              </div>
